...
public class Menu {
	 ...
	 * Comeco.
	 *
	 * IOException IOException caso ocorra um problema no arquivo txt.
	 ...
	 * Termina o programa.
	 *
	 *motivo por que o programa terminou, vazio se ocorreu o procedimento normal
	 */
	 ...
	 *
	 * usuario estrutura que armazena os dados do usuario utilizando o programa
	 * InterruptedException 
	 */
